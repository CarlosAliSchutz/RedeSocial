...
public class UsuarioService : IUsuarioService
{
    ...
    public async Task<UsuarioResponse> Cadastro(UsuarioRequest request)
    {
        ...
        {
            response.AddNotification(new Notification("O campo SenhaHash é obrigatório."));
            return response;
        }
    ...
    public async Task<LoginResponse> ValidateLogin(LoginRequest loginRequest)
    {
        ...
        if (!BC.Verify(loginRequest.Senha, usuario.SenhaHash))
        {
            response.AddNotification(new Notification("Email ou senha incorretos."));
            return response;
        }
    ...
    public async Task<UsuarioLogadoResponse> ObterDadosUsuarioLogadoAsync(int userId)
    {
