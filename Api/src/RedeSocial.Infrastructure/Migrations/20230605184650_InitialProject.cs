        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Mensagem_UsuarioId = table.Column<int>(type: "INTEGER", nullable: true),
                    Mensagem_AmigoId = table.Column<int>(type: "INTEGER", nullable: true),
                    Mensagem_Conteudo = table.Column<string>(type: "TEXT", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Bases_Bases_Mensagem_AmigoId",
                        column: x => x.Mensagem_AmigoId,
                        principalTable: "Bases",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Bases_Bases_Mensagem_UsuarioId",
                        column: x => x.Mensagem_UsuarioId,
                        principalTable: "Bases",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Bases_Mensagem_AmigoId",
                table: "Bases",
                column: "Mensagem_AmigoId");

            migrationBuilder.CreateIndex(
                name: "IX_Bases_Mensagem_UsuarioId",
                table: "Bases",
                column: "Mensagem_UsuarioId");
